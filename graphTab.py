...
class BottomPanel(wx.Panel):
	def __init__(self, parent, top):
		...
		labelChannels = wx.StaticText(self, -1, "Inputs", pos = (200,10))
		self.cb1 = wx.CheckBox(self, -1, label = "I0", pos = (200,30))
		self.cb2 = wx.CheckBox(self, -1, label = "I1", pos = (200,45))
		self.cb3 = wx.CheckBox(self, -1, label = "I2", pos = (200,60))
		self.cb4 = wx.CheckBox(self, -1, label = "I3", pos = (200,75))
...
class Main(wx.Frame):
	def __init__(self):
		wx.Frame.__init__(self, parent = None, title = "test graph", size = (600,600))
